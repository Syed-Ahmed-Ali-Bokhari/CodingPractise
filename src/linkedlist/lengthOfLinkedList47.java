...
import linkedlist.detectLoopLinkedList49.LinkedList;

public class lengthOfLinkedList47 {
	...
	public static void main(String[] args) {
		...
		LinkedList listHead1 = LinkedList.delete(listHead, data);
		LinkedList.display(listHead1);
		System.out.println(LinkedList.length(listHead1));
